...
|----------|-------------|-------|
| `GET /leads` | Alle leads (offerte-fase: request, contacted, quote_sent, inspection, lost) | `leads:read` |
| `GET /work-items` | Alle opdrachten (uitvoer-fase: pending, scheduled, in_progress, completed, cancelled) | `work-items:read` |
